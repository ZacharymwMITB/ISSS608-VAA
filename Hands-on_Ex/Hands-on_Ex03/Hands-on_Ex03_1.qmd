...
In this hands-on exercise, we will be exploring how to create interactive data visualisation by using functions in **ggiraph** and **plotlyr** packages.
...
[ggiraph](https://davidgohel.github.io/ggiraph/) ![](https://r4va.netlify.app/chap03/img/image1.jpg){width="46"} is an htmlwidget and a ggplot2 extension. It allows ggplot graphics to be interactive.
...
![](images/clipboard-2606589808.png)
