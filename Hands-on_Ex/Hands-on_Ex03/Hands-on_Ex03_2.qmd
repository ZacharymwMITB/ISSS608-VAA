...
![](images/clipboard-4155820891.png)
...
### 1.3 **Animated Data Visualisation: `gganimate` methods**
...
#### 1.3.1 Building a Static Population Bubble Plot
...
### 1.3.2 **Building the animated bubble plot**
...
### 1.4 **Animated Data Visualisation: `plotly`**

In **Plotly R** package, both `ggplotly()` and `plot_ly()` support key frame animations through the `frame` argument/aesthetic. They also support an `ids` argument/aesthetic to ensure smooth transitions between objects with the same id (which helps facilitate object constancy).

### 1.4.1 **Building an animated bubble plot: `ggplotly()` method**
...
### 1.4.2 **Building an animated bubble plot: `plot_ly()` method**
